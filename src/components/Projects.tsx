...
const Projects = () => {
  const projects = [
    {
      title: "Eco-Minds",
      description: "An AI-powered multilingual chatbot designed for healthcare awareness, accessible via WhatsApp and SMS. Built to provide health information and guidance in multiple languages.",
    ...
    },
    {
      ...
      description: "A comprehensive NGO-volunteer matching platform that connects volunteers with organizations based on skills, interests, and location. Full-stack application with robust backend.",
    ...
    },
    {
      ...
      description: "Intelligent web application that analyzes resumes using AI to provide feedback on content, formatting, and keyword optimization. Features automated deployment pipeline.",
